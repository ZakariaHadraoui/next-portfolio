...
export function NavBar() {
    ...
    return (
        <div className="flex items-center min-w-full w-full  justify-center p-2 z-[50] mt-[2rem] ">
                    ...
                    <SheetContent side="left">
                        <SheetHeader>
                            <div className="flex  justify-between">
							  <SheetTitle>Zakinnovate.</SheetTitle>
							  <ModeToggle/>
							</div>
                            <SheetDescription>
                ...
                <NavigationMenu>
                    <NavigationMenuList className="max-[825px]:hidden ">
                        <Link href="/" className="pl-2">
                            <h1 className="font-bold">Zakinnovate.</h1>
                        </Link>
                    </NavigationMenuList>
                </NavigationMenu>
